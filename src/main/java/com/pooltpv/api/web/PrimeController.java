...
public class PrimeController {
    ...
    @GetMapping(path = "/prime/code_demandeur={codeDemandeur}&date_debut={dateDebut}&date_fin={dateFin}")
    public List<PrimeDTO> getListSouscripteur(@PathVariable(name = "codeDemandeur") String  codeDemandeur,
        ...
        try {
            ...
            if (dateValidatorUsingDateTimeFormatter.isDatediffValid(startDate, endDate) == true)
                ...
                return primeService.listPrime(codeCompagnie, startDate, endDate);
